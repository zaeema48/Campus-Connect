...
public class ViewBatchAttendanceAdpter extends RecyclerView.Adapter<ViewBatchAttendanceAdpter.ViewHolder> {
    ...
    public ViewBatchAttendanceAdpter(Context context, List<StudentModel> students, List<StudentProgressModel> studentProgress) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.attendance.setText(studentProgress.get(position).getTotalClasses());
