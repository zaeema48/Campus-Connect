...
public class ChildClassSchedule extends AppCompatActivity {

    TextView m1,  m2, m3, m4, m5, t1, t2, t3, t4, t5, w1, w2, w3, w4, w5, th1, th2, th3, th4, th5, f1, f2, f3, f4, f5;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_child_class_schedule);

        fetchView();
        ProgressDialog progressDialog= new ProgressDialog(ChildClassSchedule.this);
        progressDialog.setTitle("Getting Schedule...");
        progressDialog.show();

        List<ScheduleModel> schedules=new ArrayList<>();

        ParentAPI.getParentApiInterface().classSchedule(publicParent.getStudentId()).enqueue(new Callback<List<ScheduleModel>>() {
            @Override
            ...
            public void onFailure(Call<List<ScheduleModel>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(ChildClassSchedule.this, "Error!!", Toast.LENGTH_SHORT).show();
            }
        });
    }

    public void setView(List<ScheduleModel> schedules){
//        SETTING TABLE VIEW
